...
|:---:|:---:|:---:|:---|
|신원혁|Back-End|https://github.com/god1hyuk|[리더]</br>1. Week, Day 페이지 행성 조회</br>2. QueryDsl을 활용한 월별 리포트 조회 </br>3. 캘린더에 필요한 데이터 조회</br>4. todo 페이지 |
|박종익|Back-End|https://github.com/ParkJong-ic|1. 카테고리 페이지 조회</br>2. 마이페이지 조회</br>3. 일별 통계 조회</br>4. 달성률 및 집중도 테이블 |
|이길종|Back-End|https://github.com/Jongleee|1. CICD / 무중단배포</br>2. 로그인(일반, 소셜)</br>3. 스케줄러를 이용한 기간별 통계 생성</br>4. 유저 정보 페이지</br>5. AWS이미지 업로드 |
...
![피드백반영3](https://user-images.githubusercontent.com/77233579/194345380-04e333ac-9278-4933-a5a4-5c7db84bbe21.jpg)
